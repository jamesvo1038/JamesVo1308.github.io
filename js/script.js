...
$(document).ready(function() {
	...
	$(window).scroll(function() {
		...
		$("#filters a").click(function() {
			...
			// when you're inside a click handler and you return false
			// it means don't do anything else
			return false;
		});

		$("#navigation li a").click(function(e) {
			//the click event don't do whatever else you could do
			e.preventDefault();

			//Get the href attribute of that item we clicked on
